...
const HomeBody: FunctionComponent<Props> = (props) => {
  ...
  useEffect(() => {
    ...
    SolutionService.getSolutions()
      .then(data => setSolutions(data.model.result.map(dto => 
        new SolutionDTO().copy(dto).Map())))
  ...
  useEffect(() => {
    ...
    TemplateService.getTemplates()
      .then(data => setTemplates(data.model.result.map(dto => 
        new TemplateDTO().copy(dto).Map())))
